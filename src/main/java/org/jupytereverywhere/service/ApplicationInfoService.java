...
public class ApplicationInfoService {
  ...
  /**
   * Gets the application version from build properties. Falls back to a default if build properties
   * are not available.
   *
  ...
  /**
   * Gets the application name from build properties. Falls back to a default if build properties
   * are not available.
   *
  ...
  /**
   * Gets the application group from build properties. Falls back to a default if build properties
   * are not available.
   *
